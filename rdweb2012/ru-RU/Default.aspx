...
<script runat="server">
    ...
    // Localizable Text
    //
    const string L_RemoteAppProgramsLabel_Text = "Удаленные приложения RemoteApp и рабочие столы";
    const string L_DesktopTab_Text = "Подключение к удаленному ПК";
    const string L_BadFolderErrorTitle_Text = "Папка не существует. Выполняется перенаправление...";
    const string L_BadFolderErrorBody_Text = "Вы попытались загрузить папку, которая не существует. Сейчас вы будете перенаправлены в папку верхнего уровня.";
