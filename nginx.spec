#
# Custom nginx build with full WebDAV support (http_dav_module + nginx-dav-ext-module)
#
# Based on http://www.tekovic.com/adding-custom-modules-to-nginx-rpm
#
# Matvey Marinin 2014
#
...
Source10: https://github.com/arut/nginx-dav-ext-module/archive/master.zip
...
./configure \
        ...
        --add-module=%{_builddir}/nginx-dav-ext-module-master \
        $*
make %{?_smp_mflags}
